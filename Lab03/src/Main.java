...
public class Main {
	...
	public static void inputs(){ //menu para realizar algumas operações
		...
		switch (opcoes){
			...
			case 5:
				String vazio6 = input.nextLine();
				System.out.println("");
				System.out.print("digite o nome do cliente: ");
				String cliente5 = input.nextLine();
				porto.visualizarSinistro(cliente5);
			case 6:
				String vazio7 = input.nextLine();
				System.out.println("");
				porto.listarSinistros();
